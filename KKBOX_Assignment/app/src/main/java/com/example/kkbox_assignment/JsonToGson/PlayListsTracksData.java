...
public class PlayListsTracksData {
    private int duration;
    private PlayListsTracksDataAlbum album;
    private String name;
    ...
    public PlayListsTracksDataAlbum getAlbum() {
        return this.album;
    }

    public void setAlbum(PlayListsTracksDataAlbum album) {
        this.album = album;
    }
