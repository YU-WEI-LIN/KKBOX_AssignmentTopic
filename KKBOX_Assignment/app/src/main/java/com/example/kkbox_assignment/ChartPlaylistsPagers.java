...
public class ChartPlaylistsPagers extends RelativeLayout {
    String access_token;
    public ChartPlaylistsPagers(Context context, int PageNumber) {
        super(context);
        LayoutInflater inflater = LayoutInflater.from(context);
        View view = inflater.inflate(R.layout.chartplaylistspagers_layout, null);//連接頁面
    ...
    private void GetChartPlaylists(final Context context) {
        OkHttpClient client = new OkHttpClient().newBuilder().build();
        Request request = new Request.Builder()
        ...
        call.enqueue(new Callback() {
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                new Handler(Looper.getMainLooper()).post(new Runnable() {
                    public void run() {
                        RecyclerView recyclerView3 = (RecyclerView) findViewById(R.id.chartplaylistsView);
                        ...
                        recyclerView3.setAdapter(latestFeaturedPlayLists);
